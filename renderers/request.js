...
function create_header_template(key = "", value = "") {
    return `
    <div class="item">
        <div class="key">
            <input type="text" class="form-control params_key" name="headers_key[]" placeholder="Header Key" value="` + key + `"/>
        </div>
        <div class="value">
            <input type="text" class="form-control params_value" name="headers_value[]" placeholder="Header Value" value="` + value + `"/>
        </div>
        <div class="operation">
